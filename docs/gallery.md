...
![Closeup](../Assets/Closeup.gif){: loading="lazy" }

## Concept Sketches

![Sketch 1](../Assets/sketches/1.JPEG){: loading="lazy" }
...
![Game of Life Layer](../Assets/GoL-Layer.gif){: loading="lazy" }
...
![DLA](../Assets/DLA.gif){: loading="lazy" }
